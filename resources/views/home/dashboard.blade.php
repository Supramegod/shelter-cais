...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="col-xl-4">
        ...
        <img
            src="{{ asset('public/assets/img/illustrations/trophy.png') }}"
    ...
    <div class="col-xl-4 col-md-6">
        ...
        <div class="card-body">
            ...
            <li class="d-flex mb-3">
                ...
                <img
                    src="{{ asset('public/assets/img/icons/brands/facebook-rounded.png') }}"
                    alt="facebook"
                    class="me-3"
                    height="34" />
                </div>
            ...
            <li class="d-flex mb-3">
                <div class="flex-shrink-0">
                <img
                    src="{{ asset('public/assets/img/icons/brands/dribbble-rounded.png') }}"
                    alt="dribbble"
                    class="me-3"
                    height="34" />
                </div>
            ...
            <li class="d-flex mb-3">
                <div class="flex-shrink-0">
                <img
                    src="{{ asset('public/assets/img/icons/brands/twitter-rounded.png') }}"
                    alt="facebook"
                    class="me-3"
                    height="34" />
                </div>
            ...
            <li class="d-flex">
                <div class="flex-shrink-0">
                <img
                    src="{{ asset('public/assets/img/icons/brands/instagram-rounded.png') }}"
                    alt="instagram"
                    class="me-3"
                    height="34" />
                </div>
    ...
    <div class="col-xl-4 col-md-6">
        ...
        <div class="card-body">
            ...
            <li class="d-flex mb-4 pb-1">
                ...
                <img src="{{ asset('public/assets/img/avatars/4.png') }}" alt="avatar" class="rounded" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                <div class="me-2">
            ...
            <li class="d-flex mb-4 pb-1">
                <div class="avatar flex-shrink-0 me-3">
                <img src="{{ asset('public/assets/img/avatars/5.png') }}" alt="avatar" class="rounded" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                <div class="me-2">
            ...
            <li class="d-flex mb-4 pb-1">
                <div class="avatar flex-shrink-0 me-3">
                <img src="{{ asset('public/assets/img/avatars/3.png') }}" alt="avatar" class="rounded" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                <div class="me-2">
            ...
            <li class="d-flex mb-4 pb-1">
                <div class="avatar flex-shrink-0 me-3">
                <img src="{{ asset('public/assets/img/avatars/14.png') }}" alt="avatar" class="rounded" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                <div class="me-2">
            ...
            <li class="d-flex mb-4 pb-1">
                <div class="avatar flex-shrink-0 me-3">
                <img src="{{ asset('public/assets/img/avatars/8.png') }}" alt="avatar" class="rounded" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                <div class="me-2">
            ...
            <li class="d-flex">
                <div class="avatar flex-shrink-0 me-3">
                <img src="{{ asset('public/assets/img/avatars/1.png') }}" alt="avatar" class="rounded" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                <div class="me-2">
        ...
        <div class="table-responsive text-nowrap">
            ...
            <tbody>
                ...
                <td class="d-flex pt-3">
                    ...
                    <img
                        src="{{ asset('public/assets//img/icons/payments/logo-visa.png') }}"
                        alt="credit-card"
                        width="30" />
                    </div>
                    <div class="ms-3">
                ...
                <td class="d-flex">
                    <div class="px-2 rounded bg-lighter d-flex align-items-center h-px-30">
                    <img
                        src="{{ asset('public/assets//img/icons/payments/logo-mastercard.png') }}"
                        alt="debit-card"
                        width="30" />
                    </div>
                    <div class="ms-3">
                ...
                <td class="d-flex">
                    <div class="px-2 rounded bg-lighter d-flex align-items-center h-px-30">
                    <img
                        src="{{ asset('public/assets//img/icons/payments/logo-american-express.png') }}"
                        alt="atm-card"
                        width="30" />
                    </div>
                    <div class="ms-3">
                ...
                <td class="d-flex">
                    <div class="px-2 rounded bg-lighter d-flex align-items-center h-px-30">
                    <img src="{{ asset('public/assets//img/icons/payments/logo-visa.png') }}" alt="debit-card" width="30" />
                    </div>
                    <div class="ms-3">
