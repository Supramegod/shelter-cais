...
>>>>>>> shelter-cais/developer_jalu
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                      <div class="position-relative">
                        <input hidden type="text" class="form-control" id="training_id" name="training_id"
                          placeholder="Training id" value="{{$data->id}}" />
                        <input hidden type="text" class="form-control" readonly id="employee_id" name="employee_id"
                          placeholder="Employee id" />
                        <input hidden type="text" class="form-control" readonly id="site_id" name="site_id"
                          placeholder="Site ID" />
                        <input hidden type="text" class="form-control" readonly id="jabatan_id" name="jabatan_id"
                  ...
                  <div class="row mb-3">
                    <label class="col-sm-3 col-form-label text-sm-end"></label>
                    <div class="g-recaptcha col-sm-9 mt-4" data-sitekey="6Lf-yCAqAAAAACD0QTRflbB4lo8Lvpn-FScg-eNp">
                    </div>
                  </div>
                  <!-- <button type="submit" class="btn btn-primary mt-3">Kirim</button> -->
                  <div class="pt-4">
...
>>>>>>> shelter-cais/developer_jalu
            ...
            <div>
              <a href="https://www.facebook.com/shelterindonesiaofficial" class="footer-link me-2" target="_blank"><i
                  class="mdi mdi-facebook"></i></a>
              <a href="https://www.instagram.com/shelterindonesia_official/" class="footer-link me-2" target="_blank"><i
                  class="mdi mdi-instagram"></i></a>
              <a href="https://www.linkedin.com/company/shelterindonesia/" class="footer-link me-2" target="_blank"><i
                  class="mdi mdi-linkedin"></i></a>
              <a href="https://www.youtube.com/@ShelterIndonesia" class="footer-link" target="_blank"><i
          ...
          <div class="col-lg-2 col-md-4 col-sm-6">
            ...
            <ul class="list-unstyled mb-0">
              <li class="mb-3">
                <a href="https://shelterindonesia.id/security-service" target="_blank" class="footer-link">Petugas
                  Keamanan</a>
              </li>
              <li class="mb-3">
                <a href="https://shelterindonesia.id/cleaning-service-3/" target="_blank" class="footer-link">Kebutuhan
                  Kebersihan</a>
              </li>
              <li class="mb-3">
                <a href="https://shelterindonesia.id/labour-supply-3/" target="_blank" class="footer-link">Pasokan
                  Tenaga Kerja</a>
              </li>
            </ul>
          </div>
