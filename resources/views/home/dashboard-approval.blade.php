                    ...
                    <div class="card card-border-shadow-warning h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 pb-1">
                                ...
                                <h4 class="ms-1 mb-0 display-6">{{$jumlahMenungguDirSales}}</h4>
                            </div>
                            <p class="mb-0 text-heading ">Menunggu Approval Direktur Sales</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 mb-4">
                    <div class="card card-border-shadow-secondary h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 pb-1">
                                ...
                                <h4 class="ms-1 mb-0 display-6">{{$jumlahMenungguDirkeu}}</h4>
                            </div>
                            <p class="mb-0 text-heading ">Menunggu Approval Direktur Keuangan</p>
                        </div>
                    </div>
                </div>
                <!-- <div class="col-sm-6 col-lg-3 mb-4">
                        ...
                        <div class="card-header p-0">
                            <div class="nav-align-top">
                                <ul class="nav nav-tabs nav-fill" role="tablist">
                                    <li class="nav-item">
                                        <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                                            data-bs-target="#navs-approval-anda" aria-controls="navs-approval-anda"
                                            aria-selected="true">
                                    ...
                                    <li class="nav-item">
                                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                            data-bs-target="#navs-menunggu-approval" aria-controls="navs-menunggu-approval"
                                            aria-selected="false">
                                    ...
                                    <li class="nav-item">
                                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                            data-bs-target="#navs-belum-lengkap" aria-controls="navs-belum-lengkap"
                                            aria-selected="false">
                            ...
                            <div class="tab-content p-0">
                                <div class="tab-pane fade show active" id="navs-approval-anda" role="tabpanel">
                                    <div class="table-responsive overflow-hidden table-approval-anda">
                                        <table id="table-approval-anda" class="dt-column-search table w-100 table-hover"
                                            style="text-wrap: nowrap;">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">ID</th>
                                ...
                                <div class="tab-pane fade" id="navs-menunggu-approval" role="tabpanel">
                                    <div class="table-responsive overflow-hidden table-menunggu-approval">
                                        <table id="table-menunggu-approval" class="dt-column-search table w-100 table-hover"
                                            style="text-wrap: nowrap;">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">ID</th>
                                ...
                                <div class="tab-pane fade" id="navs-belum-lengkap" role="tabpanel">
                                    <div class="table-responsive overflow-hidden table-belum-lengkap">
                                        <table id="table-belum-lengkap" class="dt-column-search table w-100 table-hover"
                                            style="text-wrap: nowrap;">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">ID</th>
