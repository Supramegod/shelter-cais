                  ...
                  <div class="card h-100">
                    <div class="rounded text-white card-body p-5" style="background-color:#121240">
                      ...
                      <p class="mb-0 text-white" style="font-size:1rem">
                        Dapatkan solusi yang lebih baik untuk bisnis anda dengan bekerja sama bersama ahli di bidang
                    ...
                    <div class="card-body">
                      <form>
                        <div class="row g-3">
                          ...
                          <div class="col-12">
                            <div class="form-floating form-floating-outline">
                              <textarea class="form-control h-px-100" placeholder="Pesan" aria-label="Pesan"
                                name="pesan" id="pesan"></textarea>
              ...
              <div class="card-body">
                <form>
                  <div class="row g-3">
                    ...
                    <div class="col-12">
                      <div class="form-floating form-floating-outline">
                        <textarea class="form-control h-px-100" placeholder="Pesan" aria-label="Pesan" name="pesan"
                          id="pesan"></textarea>
                        <label for="pesan">Pesan</label>
                      </div>
                    </div>
          ...
          <div class="row gx-0 gy-4 g-md-5">
            <div class="col-lg-5">
              ...
              <div>
                ...
                <a href="https://www.instagram.com/shelterindonesia_official/" class="footer-link me-2"
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
              ...
              <ul class="list-unstyled mb-0">
                ...
                <li class="mb-3">
                  <a href="https://shelterindonesia.id/cleaning-service-3/" target="_blank"
                    class="footer-link">Kebutuhan
                    Kebersihan</a>
                </li>
                <li class="mb-3">
