                        ...
                        <div class="d-flex justify-content-between align-items-center w-100">
                            ...
                            <div>
                                ...
                                @else
                                    @if($pks->status_pks_id == 6 && in_array(Auth::user()->role_id, [56, 2]))
                                        <a href="javascript:void(0)" class="btn btn-info waves-effect waves-light"
                                            id="aktifkan-site" data-id="{{$pks->id}}">
                                    ...
                                    @if(!$isLowongan)
                                        <a href="javascript:void(0)" class="btn btn-warning waves-effect waves-light"
                                            id="buat-lowongan" data-id="{{$pks->id}}">
                                    ...
                                    @if($pks->status_pks_id != 7)
                                        <a href="javascript:void(0)" id="btn-ajukan-ulang"
                                ...
                                @if($pks->status_pks_id == 5)
                                    <a href="javascript:void(0)" id="btn-upload-pks"
                            ...
                            <div class="mb-3" id="right-panel">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="informasi-dasar-tab" data-bs-toggle="tab"
                                            href="#informasi-dasar" role="tab" aria-controls="informasi-dasar"
                                            aria-selected="true">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="activities-tab" data-bs-toggle="tab" href="#activities"
                                            role="tab" aria-controls="activities" aria-selected="true">
                                            <i class="mdi mdi-calendar-check"></i> &nbsp; Aktifitas
                                        </a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="hpp-tab" data-bs-toggle="tab" href="#hpp" role="tab"
                                            aria-controls="hpp" aria-selected="false">
                                            <i class="mdi mdi-cash-multiple"></i> &nbsp; HPP</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="coss-tab" data-bs-toggle="tab" href="#coss" role="tab"
                                            aria-controls="coss" aria-selected="false">
                                            <i class="mdi mdi-currency-usd"></i> &nbsp; Harga Jual</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="gpm-tab" data-bs-toggle="tab" href="#gpm" role="tab"
                                            aria-controls="gpm" aria-selected="false">
                                            <i class="mdi mdi-chart-line"></i> &nbsp; GPM</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="issues-tab" data-bs-toggle="tab" href="#issues" role="tab"
                                            aria-controls="issues" aria-selected="false">
                                            <i class="mdi mdi-alert-circle"></i> &nbsp; Issue</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="perjanjian-tab" data-bs-toggle="tab" href="#perjanjian"
                                            role="tab" aria-controls="perjanjian" aria-selected="false">
                                ...
                                <div class="tab-content" id="myTabContent">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex justify-content-center gap-2 mt-2">
                                                                        <a href="{{ route('pks.isi-checklist', ['id' => $quotation->id, 'pks_id' => $pks->id]) }}"
                                                                            class="btn btn-primary" title="Isi Checklist">
                                                                            <i class="mdi mdi-pencil"></i>
                                                                        </a>
                                                                        @if($quotation->materai != null)
                                                                            <a onclick="window.open('{{route('quotation.cetak-checklist', ['id' => $quotation->id, 'pks_id' => $pks->id])}}','name','width=600,height=400')"
                                    ...
                                    <div class="tab-pane fade" id="activities" role="tabpanel"
                                        ...
                                        <div class="d-flex justify-content-end mb-3">
                                            <a href="{{ route('customer-activity.add-activity-kontrak', $pks->id) }}"
                                                    ...
                                                    <div class="timeline-event card card-border-shadow-primary mb-3 ">
                                                        <div class="card-header" style="padding-bottom:0px !important">
                                                            <button class="btn btn-danger btn-sm float-end"
                                                                onclick="deleteAktifitas({{ $activity->id }})">
                                                        ...
                                                        <div class="card-body" style="padding-top:0px !important">
                                                            @if($activity->tgl_realisasi)
                                                                <p class="card-text" style="margin-bottom:0px !important">Tanggal :
                                                                    {{ \Carbon\Carbon::createFromFormat('Y-m-d', $activity->tgl_realisasi)->isoFormat('D MMMM Y') }}
                                                                </p>
                                                            @endif
                                                            @if($activity->jam_realisasi)
                                                                <p class="card-text" style="margin-bottom:0px !important">Jam :
                                                                    {{ \Carbon\Carbon::parse($activity->jam_realisasi)->format('H:i') }}
                                                                </p>
                                                            @endif
                                                            @if($activity->start && $activity->end)
                                                                <p class="card-text" style="margin-bottom:0px !important">Jam :
                                                                    {{ \Carbon\Carbon::parse($activity->start)->format('H:i') }} s/d
                                                                    {{ \Carbon\Carbon::parse($activity->end)->format('H:i') }}</p>
                                                            @endif
                                                            @if($activity->durasi)
                                                                <p class="card-text" style="margin-bottom:0px !important">Durasi :
                                                                    {{$activity->durasi}}</p>
                                                            @endif
                                                            @if($activity->jenis_visit)
                                                                <p class="card-text" style="margin-bottom:0px !important">Jenis
                                                                    Visit : {{$activity->jenis_visit}}</p>
                                                            @endif
                                                            @if($activity->notes)
                                                                <p class="card-text" style="margin-bottom:0px !important">Notes :
                                                                    {{$activity->notes}}</p>
                                                            @endif
                                                            @if($activity->notes_tipe)
                                                                <p class="card-text" style="margin-bottom:0px !important">Notes :
                                                                    {{$activity->notes_tipe}}</p>
                                                            @endif
                                                            @if($activity->notulen)
                                                                <p class="card-text" style="margin-bottom:0px !important">Notulen :
                                                                    {{$activity->notulen}}</p>
                                                            @endif
                                    ...
                                    <div class="tab-pane fade" id="issues" role="tabpanel" aria-labelledby="issues-tab">
                                        <div class="d-flex justify-content-end mb-3">
                                            <a href="{{ route('monitoring-kontrak.add-issue', $pks->id) }}"
                                                class="btn btn-primary">
                                                ...
                                                <li class="timeline-item">
                                                    ...
                                                    <div class="timeline-event card card-border-shadow-danger mb-3 ">
                                                        <div class="card-header" style="padding-bottom:0px !important">
                                                            ...
                                                            <h6 class="timeline-title">{{$issue->jenis_keluhan}} -
                                                                {{$issue->judul}}</h6>
                                                        </div>
                                                        <div class="card-body" style="padding-top:0px !important">
                                                        ...
                                                        @if($issue->url_lampiran)
                                                            <div class="card-footer">
                                                                <a href="{{ $issue->url_lampiran }}" target="_blank"
                                                                    class="btn btn-info">
                                    ...
                                    <div class="tab-pane fade" id="perjanjian" role="tabpanel"
                                        aria-labelledby="perjanjian-tab">
                                        <!-- <div class="d-flex justify-content-end mb-3">
                                                ...
                                                <li class="timeline-item">
                                                    ...
                                                    <div class="timeline-event card card-border-shadow-info mb-3">
                                                        <div
                                                            ...
                                                            <a href="{{ route('pks.edit-perjanjian', $value->id) }}"
