                            ...
                            @foreach($quotation as $key => $quotation)
                                <div class="row mb-3">
                                    ...
                                    <ul class="list-group">
                                        ...
                                        @endforeach
                                        <li class="list-group-item">SPK : <b>@if($quotation->spk!=null){{$quotation->spk->nomor}} @else - @endif</b></li>
                                        <li class="list-group-item">PKS : <b>@if($quotation->pks!=null){{$quotation->pks->nomor}} @else - @endif</b></li>
                                    </ul>
                                </div>
                            @endforeach
                        </div>
