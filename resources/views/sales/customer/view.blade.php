...
<div class="container-fluid flex-grow-1 container-p-y">
  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Sales/ </span> Lihat Customer</h4>
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      <div class="card mb-4">
        ...
        <form class="card-body overflow-hidden" action="#" method="POST">
          @csrf
          ...
          <hr class="my-4 mx-4">
          <h6>2. Kebutuhan Customer</h6>
          <div class="row mb-2">
            <label class="col-sm-2 col-form-label text-sm-end">Sumber Customer</label>
            <div class="col-sm-4">
              <div class="position-relative">
          ...
          <hr class="my-4 mx-4">
          <div class="row mb-3">
            <label class="col-sm-2 col-form-label text-sm-end">Detail Customer</label>
            <div class="col-sm-10">
    ...
    <div class="col-md-4">
      ...
      <div class="row mt-4">
        <div class="card h-100">
          <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="card-title m-0 me-2">Customer Activity</h5>
            <div class="dropdown">
            ...
            <ul class="timeline card-timeline mb-0">
              ...
              <li class="timeline-item timeline-item-transparent border-transparent">
                ...
                <div class="timeline-event pb-1">
                  ...
                  <p class="mb-0">Customer Terbentuk</p>
                </div>
              </li>
              <!-- <li class="timeline-item timeline-item-transparent border-transparent">
                <span class="timeline-point timeline-point-info"></span>
