...
@section('title','Edit Note Harga Jual')
@section('content')
<!--/ Content -->
      ...
      <div class="card mb-4">
        <h5 class="card-header">
          <div class="d-flex justify-content-between">
            <span class="text-center">Note Harga Jual</span>
          </div>
        </h5>
        <form class="card-body overflow-hidden" action="{{route('lengkapi-quotation.save-edit-note-harga-jual')}}" method="POST" enctype="multipart/form-data">
          @csrf
          <div id="account-details-1" class="content active">
            <div class="content-header mb-5 text-center">
              <h4 class="mb-3">EDIT NOTE HARGA JUAL</h4>
              <h4>{{$data->nomor}}</h4>
...
<script>
  ...
  $('#btn-submit').on('click',function(e){
    ...
    var initialContent = `{!! $data->note_harga_jual !!}`;
