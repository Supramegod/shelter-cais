<div class="row mt-5">
    ...
    @if(!$isEdit)
        ...
        @if($request->step>1)
            <a href="{{route('lengkapi-quotation.step',['id'=>$quotation->id,'step'=>$stepSebelumnya])}}" class="btn btn-primary btn-back w-20">
    ...
    @else
        ...
        <a href="{{route('lengkapi-quotation.view',['id'=>$quotation->id])}}" class="btn btn-secondary w-30">
            <i class="mdi mdi-arrow-left"></i>
