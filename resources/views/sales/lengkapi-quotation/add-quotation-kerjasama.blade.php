...
@section('title','Tambah Syarat dan Ketentuan Kerjasama')
@section('content')
<!--/ Content -->
  ...
  <div class="row">
    ...
    <div class="col-12 mb-4">
      <div class="card mb-4">
        ...
        <form class="card-body overflow-hidden" action="{{route('lengkapi-quotation.save-add-quotation-kerjasama')}}" method="POST" enctype="multipart/form-data">
          @csrf
          <div id="account-details-1" class="content active">
            <div class="content-header mb-5 text-center">
              <h4 class="mb-3">Tambah SYARAT DAN KETENTUAN KERJASAMA</h4>
