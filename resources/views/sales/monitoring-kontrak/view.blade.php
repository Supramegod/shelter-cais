                    ...
                    <div class="d-flex justify-content-between align-items-center w-100">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                @elseif($quotation->step < 100)
                                    @if($quotation->is_sandbox == 0)
                                        <a href="{{ route('lengkapi-quotation.step', ['id' => $quotation->id, 'step' => $quotation->step]) }}"
                                            class="btn btn-primary">
                                            <i class="mdi mdi-file-document-edit-outline"></i> &nbsp; Lanjutkan Quotation
                                        </a>
                                    @else
                                        <a href="{{ route('quotation-sandbox.step', ['id' => $quotation->id, 'step' => $quotation->step]) }}"
                                ...
                                <div class="row mb-5">
                                    <table class="table table-bordered table-striped">
                                        <thead class="thead-light" style="background-color: #28a745;">
                                            <tr>
                                                <th colspan="2" style="color:white !important">Informasi Leads / Customer
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                            ...
                            <div class="offset-md-1 col-md-7 mb-3" id="right-panel">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="activities-tab" data-bs-toggle="tab"
                                            href="#activities" role="tab" aria-controls="activities" aria-selected="true">
