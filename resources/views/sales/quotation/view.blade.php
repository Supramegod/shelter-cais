                ...
                <div class="card-body pt-1">
                    <div
                        ...
                        <div class="d-flex flex-column justify-content-center">
                            <h5 class="mb-1 mt-3">
                                {{ $quotation->nama_perusahaan }} - {{ $quotation->nomor }} - Revisi Ke :
                                {{ $quotation->revisi }} @if ($quotation->is_aktif == 0)
                                    <span
                                        class="badge @if ($quotation->status_quotation_id == 8) bg-label-danger @else bg-label-info @endif rounded-pill mt-1">{{ $quotation->status }}</span>
                                @endif
                            ...
                            <div class="mt-2 mb-3">
                                ...
                                @else
                                    @if ($quotation->step == 100 && $quotation->ot1 == null)
                                        <span class="badge bg-label-warning rounded-pill mt-1">Membutuhkan Approval Direktur
                                            Sales</span>
                                    @endif
                        ...
                        <div class="d-flex align-content-center flex-wrap gap-2">
                            @if ($quotation->step != 100)
                                <a href="{{ route('quotation.step', ['id' => $quotation->id, 'step' => $quotation->step]) }}"
                                    class="btn btn-primary"><i class="mdi mdi-list-box-outline"></i>&nbsp; Lanjutkan
                                    Pengisian</a>
                            @else
                                ...
                                @if ($quotation->pks == null)
                                    <a href="javascript:void(0)" class="btn btn-danger" id="btn-ajukan-quotation"><i
                                            class="mdi mdi-refresh"></i>&nbsp; Ajukan Ulang</a>
                                    <button type="button"
                                        onclick="window.location.href='{{ route('spk.add', ['id' => $quotation->id]) }}'"
                                        class="btn btn-info" @if ($canCreateSpk == 0) disabled @endif><i
                                            class="mdi mdi-arrow-right"></i>&nbsp; Create SPK</button>
                                @endif
                                <br>
                                <div class="btn-group" role="group">
                                    <button id="btncetak" type="button" class="btn btn-primary dropdown-toggle"
    ...
    <ul class="dropdown-menu">
               ...
               Cetak Quotation Per Site
                                        ...
                                        @if ($quotation->is_aktif == 1)
                                            <li><a class="dropdown-item"
                                                    ...
                                                    rel="noopener noreferrer" href="javascript:void(0)">Cetak Harga Jual</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                                    onclick="window.open('{{ route('quotation.cetak-hpp', $quotation->id) }}','name','width=600,height=400')"
                                                    rel="noopener noreferrer" href="javascript:void(0)">Cetak HPP</a></li>
                                            <li><a class="dropdown-item"
                                                    onclick="window.open('{{ route('quotation.cetak-gpm', $quotation->id) }}','name','width=600,height=400')"
                                                    rel="noopener noreferrer" href="javascript:void(0)">Cetak GPM</a></li>
                                        @endif
                            ...
                            @endif
                            <button id="delete-quotation" class="btn btn-danger" data-id="{{ $quotation->id }}"
                                @if ($quotation->is_aktif == 1) disabled @endif><i class="mdi mdi-trash-can"></i>&nbsp;
                                Delete</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-7">
                    ...
                    <div class="card-body">
                        <div class="text-nowrap">
                            <table class="table">
                                ...
                                <tr>
                                    <td>TOP Invoice @if ($quotation->top == 'Lebih Dari 7 Hari')
                                            <span class="badge bg-label-warning rounded-pill">Butuh Approval Direksi</span>
                                        @endif
                                    </td>
                                    <td>: {{ $quotation->top }}</td>
                                    @if ($quotation->top == 'Lebih Dari 7 Hari')
                                        <td colspan="2">( {{ $quotation->jumlah_hari_invoice }} Hari
                                            {{ $quotation->tipe_hari_invoice }} )</td>
                                    @else
                                        <td colspan="2">&nbsp;</td>
                                    @endif
                                </tr>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tr>
                                    ...
                                    <td>Entitas</td>
                                    <td>: {{ $quotation->company }} @if ($quotation->company_id == 17)
                                            <span class="badge bg-label-warning rounded-pill">Butuh Approval Direksi</span>
                                        @endif
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>Nominal Upah @if ($quotation->nominal_upah < $quotation->umk)
                                            <span class="badge bg-label-warning rounded-pill">Butuh Approval</span>
                                        @endif
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>Persentase @if ($quotation->persentase < 7)
                                            <span class="badge bg-label-warning rounded-pill">Butuh Approval</span>
                                        @endif
                                    </td>
                                ...
                                <tr>
                                    ...
                                    @else
                                        <td>Nominal</td>
                                        <td colspan="2">: Rp {{ number_format($quotation->nominal_takaful, 2, ',', '.') }}
                                        </td>
                                    @endif
                                </tr>
                                @if ($quotation->penjamin == 'BPJS')
                                    <tr>
                                        <td>Macam BPJS</td>
                                        <td colspan="3">: BPJS JKK , BPJS JKM @if ($quotation->program_bpjs == '3 BPJS' || $quotation->program_bpjs == '4 BPJS')
                                                , BPJS JHT
                                                @endif @if ($quotation->program_bpjs == '4 BPJS')
                                                    , BPJS JP
                                                @endif
                                        </td>
                                    </tr>
                                ...
                                <tr>
                                    <td>Kompensasi</td>
                                    <td>{{ $quotation->kompensasi }} @if ($quotation->jenis_kontrak == 'Reguler' && $quotation->kompensasi == 'Tidak Ada')
                                            <span class="badge bg-label-warning rounded-pill mt-1">Membutuhkan Approval
                                                Direktur Sales</span>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        @if ($quotation->nominal_tunjangan_holiday != null)
                                            {{ 'Rp. ' . number_format($quotation->nominal_tunjangan_holiday, 2, ',', '.') }}
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        @if ($quotation->nominal_lembur != null)
                                            {{ 'Rp. ' . number_format($quotation->nominal_lembur, 2, ',', '.') }}
                                        @endif
                                    </td>
                                </tr>
                            </table>
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title m-0">{{ $quotation->kebutuhan }} Details ( Total Headcount :
                            {{ $quotation->totalHc }} )</h5>
                        @if ($quotation->step == 100 && $quotation->is_aktif == 0)
                                ...
                                <ul class="nav nav-tabs nav-fill" role="tablist">
                                    @foreach ($quotation->detail as $kkd => $detail)
                                        <li class="nav-item" role="presentation">
                                            <button type="button"
                                                class="nav-link waves-effect @if ($loop->first) active @endif"
                                                role="tab" data-bs-toggle="tab"
                                                data-bs-target="#navs-top-{{ $detail->id }}"
                                                aria-controls="navs-top-{{ $detail->id }}" aria-selected="true">
                            ...
                            <div class="tab-content p-0">
                                @foreach ($quotation->detail as $kkd => $detail)
                                    <div class="tab-pane fade @if ($loop->first) active show @endif"
                                        id="navs-top-{{ $detail->id }}" role="tabpanel">
                                        <table class="w-100 mb-3">
                                            <tr>
                                                <td style="display:flex;justify-content:end">
                                                    <button class="btn btn-primary btn-input-requirement"
                                                        id="btn-input-requirement-{{ $detail->id }}"
                                                        data-id="{{ $detail->id }}"><i class="mdi mdi-pen"></i>&nbsp;
                                                        Input Requirement</button>
                                                </td>
                                            </tr>
                                        </table>
                                        <div
                                            class="table-responsive overflow-hidden table-data-requirement-{{ $detail->id }}">
                                            <table id="table-data-requirement-{{ $detail->id }}"
                                                class="dt-column-search table w-100 table-hover"
...
@else
                            ...
                            <table class="table table-hover">
                                <tbody class="table-border-bottom-0">
                                    @foreach ($aplikasiPendukung as $value)
                                        <tr>
                                            <td>
                                                <img src="{{ $value->link_icon }}"
                                                    alt="{{ $value->aplikasi_pendukung }}" style="max-width:60px">
                                            </td>
            ...
            <div class="col-12 col-lg-12">
                                ...
                                <ul class="nav nav-tabs nav-fill" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button type="button" class="nav-link waves-effect active" role="tab"
                                            data-bs-toggle="tab" data-bs-target="#navs-top-hpp"
                                            aria-controls="navs-top-hpp" aria-selected="false" tabindex="-1">
                                            HPP
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button type="button" class="nav-link waves-effect" role="tab"
                                            data-bs-toggle="tab" data-bs-target="#navs-top-coss"
                                            aria-controls="navs-top-coss" aria-selected="false" tabindex="-1">
                                            Harga Jual
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button type="button" class="nav-link waves-effect" role="tab"
                                            data-bs-toggle="tab" data-bs-target="#navs-top-gpm"
                                            aria-controls="navs-top-gpm" aria-selected="false" tabindex="-1">
                                            Analisa GPM
                                        </button>
                                    </li>
                                    <span class="tab-slider" style="left: 0px; width: 91.4062px; bottom: 0px;"></span>
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center">
                        ...
                        <a href="{{ route('quotation.export.detail-coss', ['id' => $quotation->id, 'jenis' => 'All']) }}"
                            class="btn btn-success btn-next w-20">
                            <span class="align-middle me-sm-1"><i class="mdi mdi-file-excel"></i>&nbsp; Export
                                Semua</span>
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="card-header p-0">
                            <div class="nav-align-top">
                                <ul class="nav nav-tabs nav-fill" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button type="button" class="nav-link waves-effect active" role="tab"
                                            data-bs-toggle="tab" data-bs-target="#navs-top-kaporlap"
                                            aria-controls="navs-top-kaporlap" aria-selected="true">
                                            Kaporlap
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button type="button" class="nav-link waves-effect" role="tab"
                                            data-bs-toggle="tab" data-bs-target="#navs-top-ohc"
                                            aria-controls="navs-top-ohc" aria-selected="false" tabindex="-1">
                                            OHC
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button type="button" class="nav-link waves-effect" role="tab"
                                            data-bs-toggle="tab" data-bs-target="#navs-top-devices"
                                            aria-controls="navs-top-devices" aria-selected="false" tabindex="-1">
                                            Devices
                                        </button>
                                    </li>
                                    @if ($quotation->kebutuhan_id == 3)
                                        <li class="nav-item" role="presentation">
                                            <button type="button" class="nav-link waves-effect" role="tab"
                                                data-bs-toggle="tab" data-bs-target="#navs-top-chemical"
                                                aria-controls="navs-top-chemical" aria-selected="false" tabindex="-1">
                                                Chemical
                                            </button>
                                        </li>
                                    @endif
                        ...
                        <div class="card-body">
                          ...
                          <span class="align-middle me-sm-1">Edit</span>
                                        ...
                                        <div class="col-12 d-flex justify-content-end">
                                            <div></div>
                                            <a href="{{ route('quotation.export.detail-coss', ['id' => $quotation->id, 'jenis' => 'Kaporlap']) }}"
                                                class="btn btn-success btn-next w-20">
                                            ...
                                            <table class="table">
                                                            ...
                                                            @if ($kaporlap->jenis_barang == $jenisKaporlap->jenis_barang)
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:right">Rp
                                                                        {{ number_format($kaporlap->harga, 0, ',', '.') }}
                                                                    </td>
                                                                    <td style="text-align:center">{{ $kaporlap->jumlah }}
                                                                    </td>
                                                                </tr>

                                                                @php
                                                                    $totalKaporlap +=
                                                                        $kaporlap->jumlah * $kaporlap->harga;
                                                                @endphp
                                                            @endif
                                                        @endforeach
                                                    </tbody>
                                                ...
                                                <tbody>
                                                    <tr class="table-success">
                                                        <td><b>TOTAL</b> </td>
                                                        <td style="text-align:right">Rp
                                                            {{ number_format($totalKaporlap, 0, ',', '.') }}</td>
                            ...
                            <span class="align-middle me-sm-1">Edit</span>
                                        ...
                                        <div class="col-12 d-flex justify-content-between">
                                            <div></div>
                                            <a href="{{ route('quotation.export.detail-coss', ['id' => $quotation->id, 'jenis' => 'OHC']) }}"
                                                class="btn btn-success btn-next w-20">
                                                <span class="align-middle me-sm-1"><i
                                                        class="mdi mdi-file-excel"></i>&nbsp; Export OHC</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="row">
                                                        ...
                                                        @foreach ($listOhc as $ohc)
                                                            @if ($ohc->jenis_barang == $jenisOhc->jenis_barang)
                                                                <tr>
                                                                    <td>{{ $ohc->nama }}</td>
                                                                    <td style="text-align:right">Rp
                                                                        {{ number_format($ohc->harga, 0, ',', '.') }}</td>
                                                                    <td style="text-align:center">{{ $ohc->jumlah }}
                                                                    </td>
                                                                </tr>
                                                                @php
                            ...
                            <span class="align-middle me-sm-1">Edit</span>
                                        ...
                                        <div class="col-12 d-flex justify-content-between">
                                            <div></div>
                                            <a href="{{ route('quotation.export.detail-coss', ['id' => $quotation->id, 'jenis' => 'Devices']) }}"
                                                class="btn btn-success btn-next w-20">
                                                <span class="align-middle me-sm-1"><i
                                                        class="mdi mdi-file-excel"></i>&nbsp; Export Devices</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <table class="table">
                                                        ...
                                                        @foreach ($listDevices as $devices)
                                                            @if ($devices->jenis_barang == $jenisDevices->jenis_barang)
                                                                <tr>
                                                                    <td>{{ $devices->nama }}</td>
                                                                    <td style="text-align:right">Rp
                                                                        {{ number_format($devices->harga, 0, ',', '.') }}
                                                                    </td>
                                                                    <td style="text-align:center">{{ $devices->jumlah }}
                                                                    </td>
                                                                </tr>
                                                                @php
                                                ...
                                                <tbody>
                                                    <tr class="table-success">
                                                        <td><b>TOTAL</b> </td>
                                                        <td style="text-align:right">Rp
                                                            {{ number_format($totalDevices, 0, ',', '.') }}</td>
                                                        <td class="total-semua" style="text-align:right"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                            ...
                            <span class="align-middle me-sm-1">Edit</span>
                                            ...
                                            <div class="col-12 d-flex justify-content-end">
                                                <div></div>
                                                <a href="{{ route('quotation.export.detail-coss', ['id' => $quotation->id, 'jenis' => 'Chemical']) }}"
                                                    class="btn btn-success btn-next w-20 ">
                                                    <span class="align-middle me-sm-1"><i
                                                ...
                                                <table class="table">
                                                                ...
                                                                @if ($chemical->jenis_barang == $jenisChemical->jenis_barang)
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align:center">
                                                                            {{ $chemical->jumlah }}</td>
                                                                        <td style="text-align:right">Rp
                                                                            {{ number_format($chemical->harga, 0, ',', '.') }}
                                                                        </td>
                                                                        <td style="text-align:center">
                                                                            {{ $chemical->masa_pakai }}</td>
                                                                        <td style="text-align:right">
                                                                            {{ ($chemical->jumlah / $chemical->masa_pakai) * 12 }}
                                                                        </td>
                                                                        <td style="text-align:right">
                                                                            {{ ($chemical->jumlah * $chemical->harga) / $chemical->masa_pakai }}
                                                                        </td>
                                                                    </tr>
                                                                    @php
                                                                        $totalChemical +=
                                                                            $chemical->jumlah * $chemical->harga;
                                                                    @endphp
                                                                @endif
                                                            @endforeach
                                                        </tbody>
                                                    ...
                                                    <tbody>
                                                        <tr class="table-success">
                                                            <td><b>TOTAL</b> </td>
                                                            <td style="text-align:right">Rp
                                                                {{ number_format($totalChemical, 0, ',', '.') }}</td>
                                                            <td></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                            ...
                            <div class="card-body pt-0">
                                <div class="row mt-5 d-flex justify-content-center">
                                    ...
                                    @if (Auth::user()->role_id == 96 && $quotation->step == 100 && $quotation->is_aktif == 0 && $quotation->ot1 == null)
                                        <button class="btn btn-primary" id="approve-quotation"
                                            data-id="{{ $quotation->id }}" style="width:30%;"
                                            @if ($quotation->is_aktif == 1) disabled @endif>
                                            <i class="mdi mdi-draw-pen"></i>&nbsp; Approval
                                        </button>
                                    @elseif(in_array(Auth::user()->role_id, [97, 40]) &&
                                            $quotation->step == 100 &&
                                            $quotation->is_aktif == 0 &&
                                            $quotation->ot2 == null &&
    ...
    <script>
        $('body').on('click', '.view-bpjs', function() {
            const bpjsDetails = [{
                    jenis: 'JKK',
                    persen: $(this).data('persen-bpjs-jkk'),
                    nominal: $(this).data('bpjs-jkk')
                },
                {
                    jenis: 'JKM',
                    persen: $(this).data('persen-bpjs-jkm'),
                    nominal: $(this).data('bpjs-jkm')
                },
                {
                    jenis: 'JHT',
                    persen: $(this).data('persen-bpjs-jht'),
                    nominal: $(this).data('bpjs-jht')
                },
                {
                    jenis: 'JP',
                    persen: $(this).data('persen-bpjs-jp'),
                    nominal: $(this).data('bpjs-jp')
                }
            ];
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response == "Data Berhasil Ditambahkan") {
                                    $('#table-data-requirement-{{ $detail->id }}')
        ...
        $("#simpan-copy-quotation").on('click', function() {
            ...
            if (msg == "") {
                ...
                Swal.fire({
                    ...
                    text: 'Apakah Anda yakin ingin mengcopy Quotation ' + $(
                        '#quotationAsal option:selected').text() + ' ke Quotation ' + $(
                        '#quotationTujuan option:selected').text() + '?',
                    icon: 'warning',
                    showCancelButton: true,
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            let baseUrl =
                                "{{ route('quotation.ajukan-ulang-quotation', ['quotation' => ':quotation']) }}";
