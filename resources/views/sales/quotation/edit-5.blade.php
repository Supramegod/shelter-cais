          ...
          <form onSubmit="return false">
            ...
            <div id="account-details-1" class="content active">
              <div class="content-header mb-5 text-center">
                ...
                <h4>Informasi Detail Program BPJS</h4>
              ...
              <div class="row mt-5">
                ...
                <a href="{{route('quotation.edit-4',1)}}" class="btn btn-primary btn-back w-20">
                    <span class="align-middle d-sm-inline-block d-none me-sm-1">back</span>
                    <i class="mdi mdi-arrow-left"></i>
                  </a>
                  <a href="{{route('quotation.edit-6',1)}}" class="btn btn-primary btn-next w-20">
