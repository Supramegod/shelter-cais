    ...
    <div class="col-12 mb-4">
      <div class="bs-stepper wizard-vertical vertical mt-2">
        ...
        <div class="bs-stepper-content">
          <form class="card-body overflow-hidden" action="{{route('quotation-sandbox.save-edit-12')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div id="account-details-1" class="content active">
              ...
              <div class="row">
                <div class="col-12 d-flex justify-content-center">
                  <a href="{{route('quotation-sandbox.add-quotation-kerjasama',$quotation->id)}}" class="btn btn-info btn-back w-50" id="btn-tambah-kerjasama">
  ...
  $(document).ready(function(){
    $('#table-data').DataTable({
      ...
      "bInfo": false,
        ...
        ajax: {
            url: "{{ route('quotation-sandbox.list-quotation-kerjasama') }}",
            data: function (d) {
