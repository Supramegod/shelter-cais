    ...
    <div class="mb-4 overflow-auto text-nowrap" style="max-width:fit-content !important;width:auto !important;">
      <div class="bs-stepper wizard-vertical vertical mt-2">
        ...
        <div class="bs-stepper-content">
          <form class="card-body overflow-hidden" action="{{route('quotation-sandbox.save-edit-11')}}" method="POST" enctype="multipart/form-data">
            @csrf
          ...
          <div class="tab-content p-0">
            <div class="tab-pane fade active show" id="navs-top-hpp" role="tabpanel">
              <div class="row">
                ...
                <p><b><i>Note :</i></b> <a href="{{route('quotation-sandbox.edit-note-harga-jual',$quotation->id)}}"><i class="mdi mdi-pencil text-warning"></i></a> <br>
