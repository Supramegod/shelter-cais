  ...
  <div class="modal-dialog modal-md modal-simple modal-enable-otp modal-dialog-centered">
    <div class="modal-content p-3 p-md-3">
      <div class="modal-body">
        ...
        <div class="row mb-3">    
            <label class="col-sm-3 col-form-label text-sm-end"><span class="text-success">Bukti Bayar</span> </label>
            <div class="col-sm-9">
              <div class="position-relative">
                <a id ="notif_payment_bukti" target="_blank" name ="notif_payment_bukti"></a>
              </div>
            </div>
        </div>
        <div class="row mb-3">    
            <label class="col-sm-3 col-form-label text-sm-end"><span class="text-success">Invoice</span> </label>
            <div class="col-sm-9">
              <div class="position-relative">
                <a id ="notif_payment_invoice" target="_blank" name ="notif_payment_invoice"></a>
              </div>
            </div>
        </div>
        <div class="row mb-3">    
