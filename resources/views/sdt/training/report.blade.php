            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body pt-4">
                        <div class="">
                            <h6>Trainer</h6>
                            <table id="table-data-trainer" class="table" style="text-wrap: nowrap; width:90%; border: 1px solid black;">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr style='border: 1px solid black;'>
                                        <td style='font-size: 10px; border: 1px solid black;' class="text-left">{{$value->nama}}</td>
                                        <td style='font-size: 10px; border: 1px solid black;' class="text-left">{{$value->divisi}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        <div class="">
                            ...
                            <table id="table-data-trainer" class="table" style="text-wrap: nowrap; width:90%; border: 1px solid black;">
                                ...
                                <tbody>
                                    ...
                                    <tr style='border: 1px solid black;'>
                                        <td style='font-size: 10px; border: 1px solid black;' class="text-left">{{$value->client}}</td>
                                        <td style='font-size: 10px; border: 1px solid black;' class="text-left">{{$value->area}}</td>
                                        <td style='font-size: 10px; border: 1px solid black;' class="text-left">{{$value->laman}}</td>
                                        <td style='font-size: 10px; border: 1px solid black;' class="text-left">{{$value->kab_kota}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                            ...
                            <table id="table-data-trainer" class="table" style="text-wrap: nowrap; width:90%; border: 1px solid black;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style='border: 1px solid black; text-align: center' class="">Nama</th>
                                        <th style='border: 1px solid black; text-align: center' class="">No Whatsapp</th>
                                ...
                                <tbody>
                                    ...
                                    <tr style='border: 1px solid black;'>
                                        <td style='font-size: 10px; border: 1px solid black;' class="text-left">{{$value->nik}}</td>
                                        <td style='font-size: 10px; border: 1px solid black;' class="text-left">{{$value->nama}}</td>
                                        <td style='font-size: 10px; border: 1px solid black;' class="text-left">{{$value->no_whatsapp}}</td>
                                        <td style='font-size: 10px; border: 1px solid black;' class="text-left">{{$value->position}}</td>
                                        <td style='font-size: 10px; border: 1px solid black;' class="text-left">{{$value->client}}</td>
                                        <td style='font-size: 10px; border: 1px solid black;' class="text-left">{{$value->status_employee}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
