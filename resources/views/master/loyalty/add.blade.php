...
@section('title', 'Tambah Loyalty Customer')

@section('content')
    <!--/ Content -->
    <div class="container-fluid flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Master Loyalty Customer/ </span> Loyalty Customer Baru</h4>
        <div class="row ">
            <div class="col ">
                <div class="card mb-4">
                    ...
                    <form class="card-body overflow-hidden" action="{{ route('loyalty.save') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-9">                                
                                <div class="row mb-3">
