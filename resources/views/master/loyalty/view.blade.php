...
@section('title', 'View Loyalty Customer')

@section('content')
    <!--/ Content -->
    <div class="container-fluid flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Master Loyalty Customer/ </span>View Loyalty Customer</h4>
        <div class="row ">
            <div class="col ">
                <div class="card mb-4">
                    <h5 class="card-header">
                        <div class="d-flex justify-content-between">
                            <span>Form Loyalty Customer</span>
                            <span>{{ $now }}</span>
                        </div>
                    </h5>
                    <form class="card-body overflow-hidden" action="{{ route('loyalty.update',$data->id) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-9">                                
                                <div class="row mb-3">
                                    <label class="col-sm-3 col-form-label text-sm-end">Nama Loyalty<span class="text-danger">
                                            *</span></label>
                                    <div class="col-sm-8">
                                        <input type="text" id="loyalty" name="loyalty" required
                                            value="{{ old('loyalty',$data->nama) }}"
                                            class="form-control @if ($errors->any()) @if ($errors->has('loyalty')) is-invalid @else @endif @endif">
                                        @if ($errors->has('loyalty'))
                                            <div class="invalid-feedback">{{ $errors->first('loyalty') }}</div>
                                        @endif
                                    </div>
                                </div>     
                                <div class="row mb-3">
