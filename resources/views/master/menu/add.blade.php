                ...
                <div class="card mb-4">
                    ...
                    <form class="card-body overflow-hidden" action="{{ route('master.menu.save') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label text-sm-end">Opsi Menu</label>
                                    <div class="col-sm-7">
                                ...
                                <div class="row mb-3" id="parentMenuGroup" style="display: none;">
                                    <label class="col-sm-2 col-form-label text-sm-end">Pilih Menu Utama<span
                                            class="text-danger">
                                            *</span></label>
                                    <div class="col-sm-7">
                                        <div class="position-relative">
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label text-sm-end">Nama Menu<span class="text-danger">
                                            *</span></label>
                                    <div class="col-sm-7">
                            ...
                            <div class="col-sm-6">
                                <div class="row mb-3" id="kode_utama">
                                    <label class="col-sm-2 col-form-label text-sm-end">Kode<span class="text-danger">
                                            *</span></label>
                                    <div class="col-sm-7">
                                        <input type="text" id="kode" name="kode" value="{{ old('kode') }}"
                                            class="form-control @if ($errors->any()) @if ($errors->has('kode')) is-invalid @else @endif @endif">
                                        @if ($errors->has('kode'))
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label text-sm-end">URL<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-7">
                                        <div class="input-group">
                                            <span class="input-group-text" id="url_prefix"></span>
                                            <input type="text" id="url_suffix" name="url" class="form-control"
                                                placeholder="masukkan-url">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label text-sm-end">Icon</label>
                                    <div class="col-sm-7">
                                        <div class="input-group" >
    ...
    <script>
        ...
        $('#pilih_menu').on('change', function() {
            if ($(this).val() === 'child') {
                ...
                $('#menu_parent').attr('required', true);
                $('#kode_utama').hide();
                $('#kode').removeAttr('required').val('');
                $('#url_prefix').text('');
                $('#url_suffix').val('');
            } else {
                $('#parentMenuGroup').hide();
                $('#menu_parent').removeAttr('required').val('');
                $('#kode_utama').show();
        ...
        $('#menu_parent').on('change', function() {
            ...
            let parentUrl = parentUrls[parentId] || '';
            if (parentUrl) {
                $('#url_prefix').text(parentUrl.replace(/\/$/, '') + '/');
            } else {
                $('#url_prefix').text('/');
            }
            updateSuffix();
        ...
        // Update slug saat ketik nama menu
        $('#nama').on('input', function() {
            updateSuffix();
        });

        $('form').on('submit', function() {
            let prefix = $('#url_prefix').text();
            let suffix = $('#url_suffix').val();
            let fullUrl = prefix + suffix;
            $('#url_suffix').val(fullUrl);
             $('#url_prefix').val('');
        });

        function updateSuffix() {
            if ($('#pilih_menu').val() === 'child') {
                $('#url_suffix').val(slugify($('#nama').val()));
            } else {
                $('#url_suffix').val(slugify($('#nama').val()));
            }
        }
        ...
        const mdiIcons = [
            'mdi mdi-home', 'mdi mdi-account', 'mdi mdi-email', 'mdi mdi-cog', 'mdi mdi-plus', 'mdi mdi-pencil',
            'mdi mdi-delete', 'mdi mdi-eye',
            'mdi mdi-menu', 'mdi mdi-bell', 'mdi mdi-calendar', 'mdi mdi-camera', 'mdi mdi-cart', 'mdi mdi-check',
            'mdi mdi-close', 'mdi mdi-cloud', 'mdi mdi-download',
            'mdi mdi-upload', 'mdi mdi-phone', 'mdi mdi-lock', 'mdi mdi-map', 'mdi mdi-star', 'mdi mdi-heart',
            'mdi mdi-magnify', 'mdi mdi-alert', 'mdi mdi-flag',
            'mdi mdi-timer', 'mdi mdi-access-point', 'mdi mdi-access-point-network', 'mdi mdi-account',
            'mdi mdi-account-alert', 'mdi mdi-account-box', 'mdi mdi-account-box-outline',
            'mdi mdi-account-card-details', 'mdi mdi-account-check', 'mdi mdi-account-circle',
            'mdi mdi-account-convert', 'mdi mdi-account-key',
            'mdi mdi-account-location', 'mdi mdi-account-minus', 'mdi mdi-account-multiple',
            'mdi mdi-account-multiple-minus', 'mdi mdi-account-multiple-outline', 'mdi mdi-account-multiple-plus',
            'mdi mdi-account-network', 'mdi mdi-account-off', 'mdi mdi-account-outline', 'mdi mdi-account-plus',
            'mdi mdi-account-remove', 'mdi mdi-account-search', 'mdi mdi-account-settings',
            'mdi mdi-account-settings-variant', 'mdi mdi-account-star', 'mdi mdi-account-star-variant',
            'mdi mdi-account-switch',
            'mdi mdi-adjust', 'mdi mdi-air-conditioner', 'mdi mdi-airballoon', 'mdi mdi-airplane',
            'mdi mdi-airplane-landing', 'mdi mdi-airplane-off', 'mdi mdi-airplane-takeoff',
            'mdi mdi-airplay', 'mdi mdi-alarm', 'mdi mdi-alarm-check', 'mdi mdi-alarm-multiple', 'mdi mdi-alarm-off',
            'mdi mdi-alarm-plus', 'mdi mdi-album', 'mdi mdi-alert',
            'mdi mdi-alert-box', 'mdi mdi-alert-circle', 'mdi mdi-alert-circle-outline', 'mdi mdi-alert-octagon',
            'mdi mdi-alert-outline', 'mdi mdi-alpha', 'mdi mdi-alphabetical', 'mdi mdi-altimeter',
            'mdi mdi-amazon', 'mdi mdi-amazon-clouddrive', 'mdi mdi-ambulance', 'mdi mdi-amplifier', 'mdi mdi-anchor',
            'mdi mdi-android', 'mdi mdi-android-debug-bridge', 'mdi mdi-android-studio', 'mdi mdi-animation',
            'mdi mdi-apple',
            'mdi mdi-apple-finder', 'mdi mdi-apple-ios', 'mdi mdi-apple-keyboard-caps',
            'mdi mdi-apple-keyboard-command', 'mdi mdi-apple-keyboard-control', 'mdi mdi-apple-keyboard-option',
            'mdi mdi-apple-keyboard-shift', 'mdi mdi-apple-mobileme', 'mdi mdi-apple-safari',
            'mdi mdi-application', 'mdi mdi-appnet', 'mdi mdi-apps', 'mdi mdi-archive', 'mdi mdi-arrange-bring-forward',
            'mdi mdi-arrange-bring-to-front', 'mdi mdi-arrange-send-backward', 'mdi mdi-arrange-send-to-back',
            'mdi mdi-arrow-all',
            'mdi mdi-arrow-bottom-left', 'mdi mdi-arrow-bottom-right', 'mdi mdi-arrow-compress',
            'mdi mdi-arrow-compress-all', 'mdi mdi-arrow-down', 'mdi mdi-arrow-down-bold',
            'mdi mdi-arrow-down-bold-circle', 'mdi mdi-arrow-down-bold-circle-outline',
            'mdi mdi-arrow-down-bold-hexagon-outline', 'mdi mdi-arrow-down-drop-circle',
            'mdi mdi-arrow-down-drop-circle-outline', 'mdi mdi-arrow-expand', 'mdi mdi-arrow-expand-all',
            'mdi mdi-arrow-left', 'mdi mdi-arrow-left-bold', 'mdi mdi-arrow-left-bold-circle',
            'mdi mdi-arrow-left-bold-circle-outline',
            'mdi mdi-arrow-left-bold-hexagon-outline', 'mdi mdi-arrow-left-drop-circle',
            'mdi mdi-arrow-left-drop-circle-outline', 'mdi mdi-arrow-right', 'mdi mdi-arrow-right-bold',
            'mdi mdi-arrow-right-bold-circle', 'mdi mdi-arrow-right-bold-circle-outline',
            'mdi mdi-arrow-right-bold-hexagon-outline',
            'mdi mdi-arrow-right-drop-circle', 'mdi mdi-arrow-right-drop-circle-outline', 'mdi mdi-arrow-top-left',
            'mdi mdi-arrow-top-right', 'mdi mdi-arrow-up', 'mdi mdi-arrow-up-bold',
            'mdi mdi-arrow-up-bold-circle', 'mdi mdi-arrow-up-bold-circle-outline',
            'mdi mdi-arrow-up-bold-hexagon-outline', 'mdi mdi-arrow-up-drop-circle',
            'mdi mdi-arrow-up-drop-circle-outline', 'mdi mdi-assistant',
            'mdi mdi-at', 'mdi mdi-attachment', 'mdi mdi-audiobook', 'mdi mdi-auto-fix', 'mdi mdi-auto-upload',
            'mdi mdi-autorenew', 'mdi mdi-av-timer', 'mdi mdi-baby', 'mdi mdi-backburger', 'mdi mdi-backspace',
            'mdi mdi-backup-restore',
            'mdi mdi-bank', 'mdi mdi-barcode', 'mdi mdi-barcode-scan', 'mdi mdi-barley', 'mdi mdi-barrel',
            'mdi mdi-basecamp', 'mdi mdi-basket', 'mdi mdi-basket-fill', 'mdi mdi-basket-unfill', 'mdi mdi-battery',
            'mdi mdi-battery-10', 'mdi mdi-battery-20', 'mdi mdi-battery-30', 'mdi mdi-battery-40',
            'mdi mdi-battery-50', 'mdi mdi-battery-60', 'mdi mdi-battery-70', 'mdi mdi-battery-80',
            'mdi mdi-battery-90', 'mdi mdi-battery-alert', 'mdi mdi-battery-charging', 'mdi mdi-battery-charging-100',
            'mdi mdi-battery-charging-20', 'mdi mdi-battery-charging-30', 'mdi mdi-battery-charging-40',
            'mdi mdi-battery-charging-60',
            'mdi mdi-battery-charging-80', 'mdi mdi-battery-charging-90', 'mdi mdi-battery-minus',
            'mdi mdi-battery-negative', 'mdi mdi-battery-outline', 'mdi mdi-battery-plus', 'mdi mdi-battery-positive',
            'mdi mdi-battery-unknown', 'mdi mdi-beach', 'mdi mdi-beats',
            'mdi mdi-beer', 'mdi mdi-behance', 'mdi mdi-bell', 'mdi mdi-bell-off', 'mdi mdi-bell-outline',
            'mdi mdi-bell-plus', 'mdi mdi-bell-ring', 'mdi mdi-bell-ring-outline',
            'mdi mdi-bell-sleep',
            'mdi mdi-beta',
            'mdi mdi-bible',
            'mdi mdi-bike',
            ...
            'mdi mdi-ticket', 'mdi mdi-ticket-account', 'mdi mdi-ticket-confirmation', 'mdi mdi-tie',
            'mdi mdi-timelapse', 'mdi mdi-timer', 'mdi mdi-timer-10', 'mdi mdi-timer-3', 'mdi mdi-timer-off',
            'mdi mdi-timer-sand', 'mdi mdi-timetable', 'mdi mdi-toggle-switch', 'mdi mdi-toggle-switch -off',
            'mdi mdi-tooltip', 'mdi mdi-tooltip-edit', 'mdi mdi-tooltip-image', 'mdi mdi-tooltip-outline',
            'mdi mdi-tooltip-outline-plus', 'mdi mdi-tooltip-text', 'mdi mdi-tooth', 'mdi mdi-tor',
            'mdi mdi-traffic-light', 'mdi mdi-train', 'mdi mdi-tram', 'mdi mdi-transcribe', 'mdi mdi-transcribe-close',
            'mdi mdi-transfer', 'mdi mdi-translate', 'mdi mdi-tree', 'mdi mdi-trello', 'mdi mdi-trending-down',
            'mdi mdi-trending-neutral',
            'mdi mdi-trending-up', 'mdi mdi-triangle', 'mdi mdi-triangle-outline', 'mdi mdi-trophy',
            'mdi mdi-trophy-award', 'mdi mdi-trophy-outline',
            'mdi mdi-trophy-variant', 'mdi mdi-trophy-variant-outline', 'mdi mdi-truck', 'mdi mdi-truck-delivery',
            'mdi mdi-tshirt-crew', 'mdi mdi-tshirt-v', 'mdi mdi-tumblr', 'mdi mdi-tumblr-reblog', 'mdi mdi-tune',
            'mdi mdi-tune-vertical', 'mdi mdi-twitch', 'mdi mdi-twitter', 'mdi mdi-twitter-box',
            'mdi mdi-twitter-circle', 'mdi mdi-twitter-retweet',
            'mdi mdi-ubuntu', 'mdi mdi-umbraco', 'mdi mdi-umbrella', 'mdi mdi-umbrella-outline',
            'mdi mdi-undo', 'mdi mdi-undo-variant', 'mdi mdi-unfold-less', 'mdi mdi-unfold-more', 'mdi mdi-ungroup',
            'mdi mdi-untappd', 'mdi mdi-upload', 'mdi mdi-usb', 'mdi mdi-vector-arrange-above',
            'mdi mdi-vector-arrange-below', 'mdi mdi-vector-circle', 'mdi mdi-vector-circle-variant',
            'mdi mdi-vector-combine', 'mdi mdi-vector-curve',
            'mdi mdi-vector-difference', 'mdi mdi-vector-difference-ab', 'mdi mdi-vector-difference-ba',
            'mdi mdi-vector-intersection', 'mdi mdi-vector-line', 'mdi mdi-vector-point', 'mdi mdi-vector-polygon',
            'mdi mdi-vector-polyline', 'mdi mdi-vector-rectangle',
            'mdi mdi-vector-selection', 'mdi mdi-vector-square', 'mdi mdi-vector-triangle', 'mdi mdi-vector-union',
            'mdi mdi-verified', 'mdi mdi-vibrate', 'mdi mdi-video', 'mdi mdi-video-off', 'mdi mdi-video-switch',
            'mdi mdi-view-agenda', 'mdi mdi-view-array', 'mdi mdi-view-carousel', 'mdi mdi-view-column',
            'mdi mdi-view-dashboard', 'mdi mdi-view-day',
            'mdi mdi-view-grid', 'mdi mdi-view-headline', 'mdi mdi-view-list', 'mdi mdi-view-module',
            'mdi mdi-view-quilt', 'mdi mdi-view-stream', 'mdi mdi-view-week',
            'mdi mdi-vimeo', 'mdi mdi-vine', 'mdi mdi-violin', 'mdi mdi-visualstudio', 'mdi mdi-vk', 'mdi mdi-vk-box',
            'mdi mdi-vk-circle', 'mdi mdi-vlc', 'mdi mdi-voice', 'mdi mdi-voicemail', 'mdi mdi-volume-high',
            'mdi mdi-volume-low', 'mdi mdi-volume-medium', 'mdi mdi-volume-off', 'mdi mdi-vpn', 'mdi mdi-walk',
            'mdi mdi-wallet', 'mdi mdi-wallet-giftcard', 'mdi mdi-wallet-membership', 'mdi mdi-wallet-travel',
            'mdi mdi-wan', 'mdi mdi-watch', 'mdi mdi-watch-export', 'mdi mdi-watch-import', 'mdi mdi-water',
            'mdi mdi-water-off',
            'mdi mdi-water-percent', 'mdi mdi-water-pump', 'mdi mdi-watermark',
            'mdi mdi-weather-cloudy', 'mdi mdi-weather-fog', 'mdi mdi-weather-hail', 'mdi mdi-weather-lightning',
            'mdi mdi-weather-night', 'mdi mdi-weather-partlycloudy', 'mdi mdi-weather-pouring', 'mdi mdi-weather-rainy',
            'mdi mdi-weather-snowy',
            'mdi mdi-weather-sunny', 'mdi mdi-weather-sunset', 'mdi mdi-weather-sunset-down',
            'mdi mdi-weather-sunset-up', 'mdi mdi-weather-windy', 'mdi mdi-weather-windy-variant', 'mdi mdi-web',
            'mdi mdi-webcam', 'mdi mdi-webhook', 'mdi mdi-wechat', 'mdi mdi-weight', 'mdi mdi-weight-kilogram',
            'mdi mdi-whatsapp',
            'mdi mdi-wheelchair-accessibility', 'mdi mdi-white-balance-auto',
            'mdi mdi-white-balance-incandescent', 'mdi mdi-white-balance-iridescent', 'mdi mdi-white-balance-sunny',
            'mdi mdi-wifi', 'mdi mdi-wifi-off', 'mdi mdi-wii', 'mdi mdi-wikipedia',
            'mdi mdi-window-close', 'mdi mdi-window-closed', 'mdi mdi-window-maximize', 'mdi mdi-window-minimize',
            'mdi mdi-window-open', 'mdi mdi-window-restore',
            'mdi mdi-windows', 'mdi mdi-wordpress', 'mdi mdi-worker', 'mdi mdi-wrap', 'mdi mdi-wrench',
            'mdi mdi-wunderlist', 'mdi mdi-xaml', 'mdi mdi-xbox', 'mdi mdi-xbox-controller',
            'mdi mdi-xbox-controller-off', 'mdi mdi-xda', 'mdi mdi-xing', 'mdi mdi-xing-box', 'mdi mdi-xing-circle',
            'mdi mdi-xml', 'mdi mdi-yeast',
            'mdi mdi-yelp', 'mdi mdi-youtube-play', 'mdi mdi-zip-box'
