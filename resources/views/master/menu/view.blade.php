                    ...
                    <form class="card-body overflow-hidden" action="{{ route('master.menu.update', $data->id) }}"
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label text-sm-end">URL<span class="text-danger">
                                            *</span></label>
                                    <div class="col-sm-7">
                                       
                                            {{-- Sub menu: bisa edit suffix, prefix otomatis dari parent --}}
                                            <div class="input-group">
                                                <span class="input-group-text" id="url_prefix">
                                                    {{ rtrim(optional($parent->firstWhere('id', $data->parent_id))->url, '/') }}/
                                                </span>
                                                <input type="text" id="url_suffix"
                                                    value="{{ old('url', str_replace(rtrim(optional($parent->firstWhere('id', $data->parent_id))->url, '/') . '/', '', $data->url)) }}"
                                                    class="form-control @error('url') is-invalid @enderror" required>
                                            </div>
                                            <input type="hidden" name="url" id="full_url">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-3 col-form-label text-sm-end">Icon <span
...
@section('pageScript')
    <script>
        ...
        const mdiIcons = [
            ...
            'mdi mdi-delete', 'mdi mdi-eye', 'mdi mdi-menu', 'mdi mdi-bell', 'mdi mdi-calendar', 'mdi mdi-camera',
            'mdi mdi-cart', 'mdi mdi-check',
            'mdi mdi-close', 'mdi mdi-cloud', 'mdi mdi-download', 'mdi mdi-upload', 'mdi mdi-phone', 'mdi mdi-lock',
            'mdi mdi-map', 'mdi mdi-star', 'mdi mdi-heart',
            'mdi mdi-magnify', 'mdi mdi-alert', 'mdi mdi-flag', 'mdi mdi-timer', 'mdi mdi-access-point',
            'mdi mdi-access-point-network', 'mdi mdi-account',
            ...
            'mdi mdi-account-convert', 'mdi mdi-account-key', 'mdi mdi-account-location', 'mdi mdi-account-minus',
            ...
            'mdi mdi-alarm-plus', 'mdi mdi-album', 'mdi mdi-alert', 'mdi mdi-alert-box', 'mdi mdi-alert-circle',
            'mdi mdi-alert-circle-outline', 'mdi mdi-alert-octagon',
            ...
            'mdi mdi-apple', 'mdi mdi-apple-finder', 'mdi mdi-apple-ios', 'mdi mdi-apple-keyboard-caps',
            ...
            'mdi mdi-arrow-all', 'mdi mdi-arrow-bottom-left', 'mdi mdi-arrow-bottom-right', 'mdi mdi-arrow-compress',
            ...
            'mdi mdi-arrow-left-bold-circle-outline', 'mdi mdi-arrow-left-bold-hexagon-outline',
            ...
            'mdi mdi-arrow-right-bold-hexagon-outline', 'mdi mdi-arrow-right-drop-circle',
            'mdi mdi-arrow-right-drop-circle-outline', 'mdi mdi-arrow-top-left',
            ...
            'mdi mdi-arrow-up-drop-circle-outline', 'mdi mdi-assistant', 'mdi mdi-at', 'mdi mdi-attachment',
            'mdi mdi-audiobook', 'mdi mdi-auto-fix', 'mdi mdi-auto-upload',
            'mdi mdi-autorenew', 'mdi mdi-av-timer', 'mdi mdi-baby', 'mdi mdi-backburger', 'mdi mdi-backspace',
            'mdi mdi-backup-restore', 'mdi mdi-bank', 'mdi mdi-barcode', 'mdi mdi-barcode-scan', 'mdi mdi-barley',
            'mdi mdi-barrel',
            ...
            'mdi mdi-battery-charging-60', 'mdi mdi-battery-charging-80', 'mdi mdi-battery-charging-90',
            'mdi mdi-battery-minus',
            'mdi mdi-battery-negative', 'mdi mdi-battery-outline', 'mdi mdi-battery-plus', 'mdi mdi-battery-positive',
            'mdi mdi-battery-unknown', 'mdi mdi-beach', 'mdi mdi-beats', 'mdi mdi-beer', 'mdi mdi-behance',
            'mdi mdi-bell', 'mdi mdi-bell-off', 'mdi mdi-bell-outline',
            ...
            'mdi mdi-transfer',
            'mdi mdi-translate', 'mdi mdi-tree', 'mdi mdi-trello', 'mdi mdi-trending-down', 'mdi mdi-trending-neutral',
            ...
            'mdi mdi-tune-vertical', 'mdi mdi-twitch',
            'mdi mdi-twitter', 'mdi mdi-twitter-box', 'mdi mdi-twitter-circle', 'mdi mdi-twitter-retweet',
            ...
            'mdi mdi-vector-circle', 'mdi mdi-vector-circle-variant', 'mdi mdi-vector-combine', 'mdi mdi-vector-curve',
            ...
            'mdi mdi-view-agenda', 'mdi mdi-view-array',
            'mdi mdi-view-carousel', 'mdi mdi-view-column', 'mdi mdi-view-dashboard', 'mdi mdi-view-day',
            ...
            'mdi mdi-wan', 'mdi mdi-watch',
            'mdi mdi-watch-export', 'mdi mdi-watch-import', 'mdi mdi-water', 'mdi mdi-water-off',
            ...
            'mdi mdi-weather-snowy', 'mdi mdi-weather-sunny', 'mdi mdi-weather-sunset', 'mdi mdi-weather-sunset-down',
