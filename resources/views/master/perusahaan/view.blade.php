...
<div class="container-fluid flex-grow-1 container-p-y">
  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Master/ </span> Lihat Jenis Perusahaan</h4>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <div class="position-relative">
                ...
                <option value="Sangat Rendah" @if($data->resiko == 'Sangat Rendah') selected @endif>Sangat Rendah</option>
                <option value="Rendah" @if($data->resiko == 'Rendah') selected @endif>Rendah</option>
                <option value="Sedang" @if($data->resiko == 'Sedang') selected @endif>Sedang</option>
                <option value="Tinggi" @if($data->resiko == 'Tinggi') selected @endif>Tinggi</option>
                <option value="Sangat Tinggi" @if($data->resiko == 'Sangat Tinggi') selected @endif>Sangat Tinggi</option>
                </select>
          ...
          <div class="card-body">
            <div class="col-12 text-center">
              <button id="btn-update" class="btn btn-primary w-100 waves-effect waves-light">
                <span class="me-1">Update Jenis Perusahaan</span>
            ...
            <div class="col-12 text-center mt-2">
              <button id="btn-delete" class="btn btn-danger w-100 waves-effect waves-light">
                <span class="me-1">Delete Jenis Perusahaan</span>
...
<script>
  ...
  $('#btn-delete').on('click',function () {
    $('form').attr('action', '{{route("perusahaan.delete")}}');
    $('form').submit();
  });
  
  $('#btn-kembali').on('click',function () {
    window.location.replace("{{route('perusahaan')}}");
  });
</script>
@endsection