...
@section('title','Jabatan PIC')
@section('content')
<!--/ Content -->
<div class="container-fluid flex-grow-1 container-p-y">
  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Master/ </span> Lihat Jabatan PIC</h4>
      ...
      <div class="card mb-4">
        <h5 class="card-header">
          <div class="d-flex justify-content-between">
            <span>Form Jabatan PIC</span>
          </div>
        </h5>
        <form class="card-body overflow-hidden" action="{{route('jabatan.save')}}" method="POST">
          @csrf
          ...
          <div class="card-body">
            <div class="col-12 text-center">
              <button id="btn-update" class="btn btn-primary w-100 waves-effect waves-light">
                <span class="me-1">Update Jabatan PIC</span>
            ...
            <div class="col-12 text-center mt-2">
              <button id="btn-delete" class="btn btn-danger w-100 waves-effect waves-light">
                <span class="me-1">Delete Jabatan PIC</span>
...
<script>
  ...
  $('#btn-delete').on('click',function () {
    $('form').attr('action', '{{route("jabatan.delete")}}');
    $('form').submit();
  });
  
  $('#btn-kembali').on('click',function () {
    window.location.replace("{{route('jabatan')}}");
  });
</script>
@endsection