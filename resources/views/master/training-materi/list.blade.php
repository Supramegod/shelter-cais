            ...
            <div class="card">
                <div class="card-header d-flex" style="padding-bottom: 0px !important;">
                    <div class="col-md-6 text-left col-12 my-auto">
                        <h3 class="page-title">Training Materi</h3>
                        <ol class="breadcrumb" style="background-color:white !important;padding:0 !important">
							<li class="breadcrumb-item"><a href="javascript:void(0);">Master</a></li>
							<li class="breadcrumb-item active" aria-current="page">Training Materi</li>
						</ol>
                    </div>
                </div>
                <div class="card-body">
    ...
    <script>
        ...
        'language': {
            ...
            'processing': 'Loading...'
                ...
                ajax: {
                    url: "{{ route('training-materi.list') }}",
                    data: function (d) {
                ...
                buttons: [
                    {
                    text: '<i class="mdi mdi-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Tambah Training Materi</span>',
                    className: 'create-new btn btn-label-primary waves-effect waves-light',
                    action: function (e, dt, node, config)
                        {
                            //This will send the page to the location specified
                            window.location.href = '{{route("training-materi.add")}}';
                        }
                    }
                ],
            });
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{route('training-materi.delete')}}",
                        data:formData,
