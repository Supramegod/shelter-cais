...
<div class="container-fluid flex-grow-1 container-p-y">
  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Master/ </span> Training Divisi</h4>
      ...
      <div class="card mb-4">
        ...
        <form class="card-body overflow-hidden" action="{{route('training-divisi.save')}}" method="POST">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" id="divisi" name="divisi" value="{{$data->divisi}}" class="form-control @if ($errors->any()) @if($errors->has('divisi')) is-invalid @else   @endif @endif">
...
<script>
  ...
  $('#btn-kembali').on('click',function () {
    window.location.replace("{{route('training-divisi')}}");
  });
</script>
@endsection