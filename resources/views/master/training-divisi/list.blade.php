    ...
    <script>
        ...
        'language': {
            ...
            'processing': 'Loading...'
                ...
                ajax: {
                    url: "{{ route('training-divisi.list') }}",
                    data: function (d) {
                ...
                buttons: [
                    {
                    text: '<i class="mdi mdi-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Tambah Training Divisi</span>',
                    className: 'create-new btn btn-label-primary waves-effect waves-light',
                    action: function (e, dt, node, config)
                        {
                            //This will send the page to the location specified
                            window.location.href = '{{route("training-divisi.add")}}';
                        }
                    }
                ],
            });
        ...
        $('body').on('click', '.btn-delete', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{route('training-divisi.delete')}}",
                        data:formData,
