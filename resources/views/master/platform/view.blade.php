...
<div class="container-fluid flex-grow-1 container-p-y">
  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Master/ </span> Lihat Sumber Leads</h4>
      ...
      <div class="card mb-4">
        ...
        <form class="card-body overflow-hidden" action="{{route('platform.save')}}" method="POST">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <input type="text" id="nama" name="nama" value="{{$data->nama}}" class="form-control @if ($errors->any()) @if($errors->has('nama')) is-invalid @else is-valid @endif @endif">
              @if($errors->has('nama'))
          ...
          <div class="card-body">
            <div class="col-12 text-center">
              <button id="btn-update" class="btn btn-primary w-100 waves-effect waves-light">
                <span class="me-1">Update Sumber Leads</span>
            ...
            <div class="col-12 text-center mt-2">
              <button id="btn-delete" class="btn btn-danger w-100 waves-effect waves-light">
                <span class="me-1">Delete Sumber Leads</span>
...
<script>
  ...
  $('#btn-delete').on('click',function () {
    $('form').attr('action', '{{route("platform.delete")}}');
    $('form').submit();
  });
  
  $('#btn-kembali').on('click',function () {
    window.location.replace("{{route('platform')}}");
  });
</script>
@endsection