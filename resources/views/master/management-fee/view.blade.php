...
<div class="container-fluid flex-grow-1 container-p-y">
  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Master/ </span> Lihat Management Fee</h4>
      ...
      <div class="card mb-4">
        <h5 class="card-header">
          <div class="d-flex justify-content-between">
            <span>Form Management Fee</span>
          </div>
        </h5>
        <form class="card-body overflow-hidden" action="{{route('management-fee.save')}}" method="POST">
          @csrf
          ...
          <div class="card-body">
            <div class="col-12 text-center">
              <button id="btn-update" class="btn btn-primary w-100 waves-effect waves-light">
                <span class="me-1">Update Management Fee</span>
...
<script>
  ...
  $('#btn-kembali').on('click',function () {
    window.location.replace("{{route('management-fee')}}");
  });
</script>
@endsection