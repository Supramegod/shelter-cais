...
<div class="container-fluid flex-grow-1 container-p-y">
  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Master/ </span>Training Area</h4>
      ...
      <div class="card mb-4">
        ...
        <form class="card-body overflow-hidden" action="{{route('training-area.save')}}" method="POST">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" id="area" name="area" value="{{$data->area}}" class="form-control @if ($errors->any()) @if($errors->has('area')) is-invalid @else   @endif @endif">
              @if($errors->has('area'))
          ...
          <div class="card-body">
            <div class="col-12 text-center">
              <button id="btn-update" class="btn btn-primary w-100 waves-effect waves-light">
                <span class="me-1">Update Area</span>
...
<script>
  ...
  $('#btn-kembali').on('click',function () {
    window.location.replace("{{route('training-area')}}");
  });
</script>
@endsection