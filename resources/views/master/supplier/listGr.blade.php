                ...
                <div class="card">
                    <div class="card-header d-flex" style="padding-bottom: 0px !important;">
                        <div class="col-md-6 text-left col-12 my-auto">
                            <h3 class="page-title">Good Receipt</h3>
                            <ol class="breadcrumb" style="background-color:white !important;padding:0 !important">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Good Receipt</li>
                            </ol>
                        </div>
                    </div>
                    <div class="card-body pt-4">
                        <form action="{{route('supplier.Gr')}}" method="GET">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-2">
    ...
    <script>
        ...
        var table = $('#table-data').DataTable({
            ...
            columns: [
                ...
                { data: 'nomor_gr', name: 'nomor_gr', className: 'text-center' },
            ...
            buttons: [
                ...
                {
                    text: '<i class="mdi mdi-plus me-sm-1"></i> <span class="d-sm-inline-block">Tambah Good Receipt</span>',
