                ...
                <div class="card">
                    <div class="card-header d-flex" style="padding-bottom: 0px !important;">
                        <div class="col-md-6 text-left col-12 my-auto">
                            <h3 class="page-title">Receiving Notes</h3>
                            <ol class="breadcrumb" style="background-color:white !important;padding:0 !important">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Receiving Notes</li>
                            </ol>
                        </div>
                    </div>
                    <div class="card-body pt-4">
                        <form action="{{route('supplier.Rn')}}" method="GET">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-2">
                            ...
                            <table id="table-data" class="dt-column-search table w-100 table-hover"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">No Good Receipt</th>
                                        <th class="text-center">kategori Barang</th>
                                        <th class="text-center">DiBuat Taggal</th>
    ...
    <script>
        ...
        var table = $('#table-data').DataTable({
            ...
            columns: [
                ...
                { data: 'nomor_rn', name: 'nomor_rn', className: 'text-center' },
                { data: 'kategori_barang', name: 'kategori_barang', className: 'text-center' },
                { data: 'tanggal_cetak', name: 'tanggal_cetak', className: 'text-center' },
            ...
            buttons: [
                ...
                {
                    text: '<i class="mdi mdi-plus me-sm-1"></i> <span class="d-sm-inline-block">Receiving Notes</span>',
                    className: 'create-new btn btn-label-primary waves-effect waves-light',
                    action: function (e, dt, node, config) {
                        //This will send the page to the location specified
                        window.location.href = '{{route("supplier.create2")}}';
                    }
                }
            ],
        });
