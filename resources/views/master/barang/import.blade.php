...
<div class="container-fluid flex-grow-1 container-p-y">
  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Master/ </span> Import Barang</h4>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="card mb-4">
        ...
        <!-- Multi  -->
        <div class="card-body">
            <form enctype="multipart/form-data" id="upload-form" style="opacity:1 !important" action="{{route('barang.inquiry-import')}}" method="POST">
                @csrf
            ...
            <div class="pt-4">
                ...
                <div class="col-sm-12 d-flex justify-content-center">
                    ...
                    <a href="{{route('barang')}}" class="btn btn-secondary waves-effect">Kembali</a>
                </div>
                </div>
            </div>
        </div>
