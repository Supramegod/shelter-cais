                ...
                <div class="card-header d-flex" style="padding-bottom: 0px !important;">
                    <div class="col-md-6 text-left col-12 my-auto">
                        ...
                        <ol class="breadcrumb" style="background-color:white !important;padding:0 !important">
							...
							<li class="breadcrumb-item active" aria-current="page">Kaporlap</li>
						</ol>
                    </div>
                </div>
    ...
    <script>
        ...
        'language': {
            ...
            'processing': 'Loading...'
                ...
                ajax: {
                    url: "{{ route('barang.list-kaporlap') }}",
                    data: function (d) {
                ...
                buttons: [
                    ...
                    action: function (e, dt, node, config)
                        {
                            //This will send the page to the location specified
                            window.location.href = '{{ route("barang.add") }}?jenis=kaporlap';
                        }
                    }
                ],
            });
