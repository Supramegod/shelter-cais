...
class CustomerController extends Controller
{
    public function index (Request $request){
        ...
        return view('sales.customer.list',compact('branch','platform','status','tglDari','tglSampai','request','error','success'));
    }
    ...
    public function view (Request $request,$id){
        try {
            ...
            return view('sales.customer.view',compact('activity','data','branch','jabatanPic','jenisPerusahaan','kebutuhan','platform'));
        } catch (\Exception $e) {
